...
#define STEEM_BLOCKCHAIN_VERSION              ( version(0, 20, 2) )

#define STEEM_INIT_PUBLIC_KEY_STR             "STX8Tu6Mx5iXjfVjQgfsTwRMJCTxcQGp6UShTFWi2Q5pr6bLPaguf"
#define STEEM_CHAIN_ID_NAME ""
#define STEEM_CHAIN_ID (fc::sha256::hash("teststeemx"))
#define STEEM_ADDRESS_PREFIX                  "STX"

#define STEEM_GENESIS_TIME                    (fc::time_point_sec(1484438400))
#define STEEM_MINING_TIME                     (fc::time_point_sec(1484438400))
...
#define STEEM_OWNER_AUTH_RECOVERY_PERIOD                  fc::minutes(60)
#define STEEM_ACCOUNT_RECOVERY_REQUEST_EXPIRATION_PERIOD  fc::hours(5)
...
#define STEEM_MAX_RUNNER_WITNESSES_HF0        0

#define STEEM_MAX_VOTED_WITNESSES_HF17        1
#define STEEM_MAX_MINER_WITNESSES_HF17        0
#define STEEM_MAX_RUNNER_WITNESSES_HF17       0
...
#define STEEM_MAX_FEED_AGE_SECONDS            (60*60*24*7*52) // ~1 year
#define STEEM_MIN_FEEDS                       1
